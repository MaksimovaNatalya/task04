...
public class Column {
    ...
    public static final String REQUESTED_ROOM_STATUS = "status";
    public static final String REQUESTED_ROOM_THIS_ROOM_ID = "rooms_id";
    public static final String REQUESTED_ROOM_REQUESTS_ID = "requests_id";
