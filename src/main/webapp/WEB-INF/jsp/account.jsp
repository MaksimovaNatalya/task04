...
<head>
    ...
    <fmt:message bundle="${lang}" key="account.buttom_update" var="update" />
    <fmt:message bundle="${lang}" key="account.pers_info" var="pers_info" />
...
<form action="Controller" method="post">
    <input type="hidden" name="command" value="changeAccountInfo">
    <br>
    <div>
        <fieldset>
            ...
            <br/>
            <legend><h1>${pers_info}</h1></legend>
            <label for="login">${login}</label>
            <br/>
            <input type="text" id="login" name="login" value=<c:out value="${requestScope.user.login}"  />>
            <br/>
            <label for="name">${name}</label>
            <br/>
            <input type="text" id="name" name="name" value=" <c:out value="${requestScope.user.name}"  />">
            <br/>
            <label for="surname">${surname}</label>
            <br/>
            <input type="text" id="surname" name="surname" value=<c:out value="${requestScope.user.surname}"  />>
            <br/>
            ...
            <br/>
            <input type="text" id="phone" name="phone" value=<c:out value="${requestScope.user.phone}"  />>
            <br/>
